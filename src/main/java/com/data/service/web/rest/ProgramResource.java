...
import com.data.service.domain.Program;
import com.data.service.repository.ProgramRepository;
...
/**
 * REST controller for managing {@link com.data.service.domain.Program}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProgramResource {
    ...
    private static final String ENTITY_NAME = "dataserviceProgram";
